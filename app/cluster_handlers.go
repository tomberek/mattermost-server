...
func (a *App) RegisterAllClusterMessageHandlers() {
	...
	// Plugin events
	a.Cluster.RegisterClusterMessageHandler(model.CLUSTER_EVENT_INSTALL_PLUGIN, a.ClusterInstallPlugin)
	a.Cluster.RegisterClusterMessageHandler(model.CLUSTER_EVENT_REMOVE_PLUGIN, a.ClusterRemovePlugin)
...
func (a *App) ClusterInstallPlugin(msg *model.ClusterMessage) {
	a.InstallPluginFromData(model.PluginEventDataFromJson(strings.NewReader(msg.Data)))
}

func (a *App) ClusterRemovePlugin(msg *model.ClusterMessage) {
